 ...
 * @author Miguel
 */
@WebServlet(name = "restaSV", urlPatterns = {"/restaSV"})
public class restaSV extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet restaSV</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>Su Resta es: " + calcBin.resta(val1, val2)  + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
